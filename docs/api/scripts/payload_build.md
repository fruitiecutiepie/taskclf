...
- Collects third-party runtime packages individually, including the TOML writer dependency `tomli_w`, so config loading does not fail in the packaged sidecar.
