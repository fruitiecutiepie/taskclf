...
- **Tray menu order (pystray)** -- **Toggle Dashboard**, **Pause** / **Resume**, **Show Status**; then **Today's Labels**, **Import Labels**, **Export Labels**; then **Prediction Model** (submenu), **Open Data Folder**, **Edit Config**, **Report Issue**; then **Quit**. Left-click opens or toggles the dashboard depending on mode; right-click shows this menu.
